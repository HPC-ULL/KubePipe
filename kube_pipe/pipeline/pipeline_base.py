...
class PipelineBase(ABC):
    ...
    def initialize(
        ...
        *args,                 
        ...
        registry_svc: Union[str, None] = None,
        ):
        ...
        # if not registry_ip:
        #     registry_ip = "private-repository-k8s.kubepipe.svc.cluster.local"
        #     # registry_ip = self.get_service_ip(
    ...
    def __str__(self) -> str:
        return f"{self.backend}-{str(self.funcs)}"
    ...
    def get_module_dependencies(self, funcs):
        deps = ["dill", "minio", "scikit-learn", "flask"]
        for func in funcs:
